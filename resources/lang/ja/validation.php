...
return [
    ...
    */
    ...
    'custom' => [
        'not_found' => '見つかりません',
        'unauthenticated' => 'サーバーと通信中です',
        'resource_notfound' => '要求されたリソースが見つかりません',
        'Method_Not_Allowed' => '許可されていない方法',
        'Too_Many_Requests' => 'リクエストが多すぎます',
        'Invalid_webhook_signature' => '無効なWebhook署名',
        'Something_went_wrong_Please_try_again' => 'エラーが発生しました。お手数ですがしばらくしてからもう一度お試しください'
    ...
    */
    ...
    'attributes' => [
        ...
        'free_user_id' => 'ご希望ID',
        'nickname' => 'ニックネーム',
        'firstname_katakana' => 'ナマエ',
        'lastname_katakana' => 'ミョウジ',
        'icon_image_url' => 'アイコン',
        'description' => 'プロフィール',
        'gender' => '性別',
        'birthday' => '生年月日',
        'newsletter' => 'メールマガジンの購読',
        'area_id' => 'よく飲みに行くエリアID',
        'public_description' => 'レビュー',
        'private_description' => 'メモ'
    ],
